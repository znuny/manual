...
.. important:: **Frontend Architecture**
   ...
   We follow the `Object Oriented CSS <https://github.com/stubbornella/oocss>`__ approach. In essence, this means that the layout is achieved by combining different generic building blocks to realize a particular design.
