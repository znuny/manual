...
Mandatory keys have an *asterisk "\*"* in the example field and require a value. For a detailed description of the modules read the `perl API documentation <https://doc.znuny.org/legacy/api/otrs/6.0/Perl/>`_ for each transition action.
