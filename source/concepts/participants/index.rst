...
Znuny provides several ways for users to participate in a ticket:
...
.. note::
    ...
    Participation is not limited to those performing actions on the ticket. Watchers and mentioned users can follow the ticket's progress and contribute when necessary.

Adding and Managing Watchers
****************************

Agents can manually add or remove themselves as watchers to a ticket at any time. This is useful for stakeholders who need to stay updated on the ticket's status.

Automatic Participation
=======================

Znuny can be configured to automatically add participants based on certain actions, such as ticket assignment, queue changes, or workflow triggers. This ensures that the right people are always informed and involved.

.. tip::

    Automatic watcher assignment helps maintain oversight and ensures important updates are not missed.

Historical Information
======================

All changes to the list of participants, including watchers and mentions, are tracked in the ticket history. This provides transparency and allows teams to see who has been involved with the ticket at different stages.
...
Effective use of participants ensures that tickets are not overlooked and that all relevant stakeholders are kept in the loop. This is especially valuable in complex support environments or when tickets require input from multiple agents or departments.

Best Practices for Managing Participants
****************************************
...
Watching Tickets
    A ticket requires input from the IT security team. The agent watches the ticket and moves it to the “Security Review” queue. The watcher receives notifications about updates.

Using Mentions
    During a ticket discussion, an agent mentions a colleague using the mention feature to request their expertise. The mentioned user is notified and can join in on the conversation.

Automatic Watcher Assignment
    When a ticket is moved to the “VIP Support” queue, the team lead is automatically added as a watcher to ensure oversight.
