...
An example script is available to backup your system. We recommend this for small to mid-sized systems only. This script needs to be executed by the application user, typically otrs.
...
Parallel to the backup example script, a restore script as also available. This script needs to be executed by the application user, typically otrs.
