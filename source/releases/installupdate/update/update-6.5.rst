...
.. code-block::
  ...
  yum update -y https://download.znuny.org/releases/RPMS/rhel/7/znuny-6.5.18-01.noarch.rpm
...
.. code-block::
  ...
  # Set permissions
  /opt/znuny-6.5.18/bin/otrs.SetPermissions.pl
  ...
  # Create a symlink 
  ln -sf /opt/znuny-6.5.18 /opt/otrs
