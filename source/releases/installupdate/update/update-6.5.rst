...
.. code-block::
  ...
  yum update -y https://download.znuny.org/releases/RPMS/rhel/7/znuny-6.5.25-01.noarch.rpm
...
.. code-block:: bash
  ...
  cd /opt
  wget https://download.znuny.org/releases/znuny-6.5.25.tar.gz
  ...
  # Extract
  tar xfz znuny-6.5.25.tar.gz

  # Set permissions
  /opt/znuny-6.5.25/bin/otrs.SetPermissions.pl
  ...
  # Create a symlink 
  ln -sf /opt/znuny-6.5.25 /opt/otrs
