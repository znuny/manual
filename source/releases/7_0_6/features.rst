...
Read about all changes in the `CHANGES.md <https://github.com/znuny/Znuny/blob/rel-7_0_6/CHANGES.md>`_. For the complete list of all changes, see the commits on `GitHub <https://github.com/znuny/Znuny/commits/rel-7_0_6>`_.
