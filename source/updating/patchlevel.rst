...
.. note::   Your current system needs to be a Znuny 7.3.x where the x stands for the patch level. You can skip intermediate **patch levels**, e.g. update from 7.3.1 directly to 7.3.3
...
.. tab-set::
  ...
  .. tab-item:: RPM installation
        ...
        .. code-block::
            ...
            rpm -Uvh https://download.znuny.org/releases/RPMS/rhel/7/znuny-7.3.3-01.noarch.rpm
  ...
  .. tab-item:: Source installation
    :sync: source
        ...
        .. code-block:: bash
            ...
            cp -av /opt/znuny/Kernel/Config.pm /opt/znuny-7.3.3/Kernel/
            ...
            # Set the permissions
            znuny-7.3.3/bin/znuny.SetPermissions.pl
