...
.. code-block:: bash
	...
	# Update to Znuny 7.3
	dnf update -y https://download.znuny.org/releases/RPMS/rhel/7/znuny-7.3.7-01.noarch.rpm
...
.. code-block:: bash
  ...
  # Extract
  tar xfz znuny-7.3.7.tar.gz

  # Set permissions
  /opt/znuny-7.3.7/bin/znuny.SetPermissions.pl

  # Restore Kernel/Config.pm, articles, etc.
  cp -a /opt/znuny/Kernel/Config.pm /opt/znuny-7.3.7/Kernel/
